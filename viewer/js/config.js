function config() {
    return {
            ...
            cellData: [{mediaLink: 'https://media.githubusercontent.com/media.com/AlexBecalick/alexbecalick.github.io/main/viewer/data/cellData.tsv?raw=true', size: "77390949"}],
