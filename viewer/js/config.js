function config() {
    return {
            ...
            geneData: [{mediaLink: 'https://github.com/AlexBecalick/alexbecalick.github.io/blob/main/viewer/data/geneData.tsv', size: "640650110"}],
            cellBoundaries: [{mediaLink: 'https://github.com/AlexBecalick/alexbecalick.github.io/blob/main/viewer/data/cellBoundaries.tsv', size: "69547441"}],
        }
}
